  ...
  return (
    <div className="header-container">
      <div className="header">
        <h1> Solutions for the most needed with TechnoBorg</h1>
        <p>The future is getting closer and TechnoBorg is proof of that. After 5 years of studies and development, the first official prototype of domestic help will soon be released on the market:  <span>TechBorg Vx</span> . <br /> Leave us your email to make a pre-reservation and be one of the first to get your Cyborg.</p>
